use legion::{any, EntityStore, IntoQuery, Read, Universe, World};
use legion_sync::register::ComponentRegistration;
use std::{cell::RefCell, collections::HashMap};

use legion_sync::{resources::RegisteredComponentsResource, tracking::*};
...
fn main() {
    ...
    println!(
        "Number of entities in deserialized world {}",
        world_new.len()
    );
