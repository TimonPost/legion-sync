...
//     uid::UidAllocator,
// };
// use net_sync::transport::tcp::{TcpListenerResource, TcpClientResource};
//
// #[sync]
// #[derive(Debug)]
// pub struct Position {
...
// fn initial_data(world: &mut World, allocator: &mut UidAllocator<Entity>) {
//     world.insert((), test_components(allocator));
// }
//
// /// Returns some test components which can be added to an entity.
// fn test_components(allocator: &mut UidAllocator<Entity>) -> Vec<(Position, UidComponent)> {
//     vec![(
//         Position { x: 10, y: 10 },
...
//     pub uid_allocator: UidAllocator<Entity>,
// }
