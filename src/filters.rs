...
//
// use legion::{
//     storage::{ComponentStorage, ComponentTypeId},
// };
//
// use legion::query::{EntityFilterTuple, LayoutFilter};
//
// use net_sync::tracker::TrackResource;
//
// use crate::components::UidComponent;
// use legion::storage::SliceVecIter;
//
// pub mod filter_fns {
//     use std::collections::HashSet;
//
//     use legion::query::{Any, EntityFilterTuple};
//
//     use net_sync::tracker::TrackResource;
//
//     use crate::{
...
//     ) -> EntityFilterTuple<TrackFilter<'a, AllFilter>, Passthrough> {
...
//     }
//
//     pub fn registered() -> EntityFilterTuple<RegisteredComponentFilter, Any> {
...
//
// impl<'a, F: TrackResourceFilter> LayoutFilter<ChunkFilterData<'a>> for TrackFilter<'_, F> {
